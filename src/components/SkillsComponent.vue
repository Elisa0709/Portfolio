...
<template>
  <div class="bgGrey">
    <div class="container  ">
      <h1 class="text-white display-5 mb-4 text-center">Mes compétences techniques</h1>
      <div class="border-bottom border-opacity-25"></div>
    </div>
...
<!--          Enlever le grand titre et mettre chaque sous titres et ses div avec une border claire pour séparer les espaces ?-->
          ...
          <div class="row g-0 mb-4">
            ...
            <div class="col-6 col-md-2">
              <div class="bgGrey text-center mb-2">
                <img width="96" height="96" src="https://img.icons8.com/external-those-icons-flat-those-icons/96/external-PHP-programming-and-development-those-icons-flat-those-icons.png" alt="icon PHP"/>                <h4 class="card-title">PHP</h4>
              </div>
            </div>
            <div class="col-6 col-md-2">
              <div class="bgGrey text-center mb-2">
          ...
          <div class="row g-0 mb-4">
            ...
            <div class="col-6 col-md-2">
              <div class="bgGrey text-center mb-2">
                <img width="96" height="96" src="https://img.icons8.com/color/96/javascript--v1.png" alt="icon javascript"/>
            ...
            <div class="col-6 col-md-2 mb-2">
              <div class="bgGrey text-center">
                <img width="96" height="96" src="https://img.icons8.com/external-tal-revivo-color-tal-revivo/96/external-jquery-is-a-javascript-library-designed-to-simplify-html-logo-color-tal-revivo.png" alt="icon JQuery"/>
          ...
          <div class="row g-0">
            ...
            <div class="col-6 col-md-2">
              <div class="bgGrey text-center">
                ...
                <h4 class="card-title">Titre 9</h4>
              </div>
            </div>
            <div class="col-6 col-md-2">
              <div class="bgGrey text-center">
                <img width="96" height="96" src="https://img.icons8.com/fluency/96/bootstrap.png" alt="icon bootstrap"/>
                <h4 class="card-title">Bootstrap</h4>
              </div>
            </div>
            <div class="col-6 col-md-2 mt-3">
              <div class="bgGrey text-center">
                <img width="96" height="96" src="https://img.icons8.com/external-those-icons-lineal-color-those-icons/96/external-SQL-development-files-those-icons-lineal-color-those-icons.png" alt="icon SQL"/>
